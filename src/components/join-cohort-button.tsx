...
import { ReserveSpotButton } from "./reserve-spot-button";
...
export function JoinCohortButton({ className, disabled, children }: JoinCohortButtonProps) {
  ...
  const handleBookCall = () => {
    posthog?.capture("cta_book_call_clicked", { service_name: "PR Article" });
    setOpen(false);
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 sm:p-8">
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full px-6 py-4 bg-slate-900 text-white rounded-xl font-semibold hover:bg-slate-800 transition cursor-pointer text-left flex items-center gap-4"
              >
                ...
                <div>
                  ...
                  <div className="text-sm font-normal text-slate-400">Talk to Kevin first, decide later</div>
                </div>
              </button>
              ...
              >
                ...
                <div>
                  <div>Reserve My Spot &mdash; $5,000</div>
                  <div className="text-sm font-normal text-emerald-200">Secure your place now, pay online</div>
                </div>
              </ReserveSpotButton>
            </div>
          </div>
